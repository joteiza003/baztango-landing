...
export const T = {
  es: {
    ...
    eb_djs: "Equipo artístico", djs_h2: "DJs de Baztango <em>20.</em>", djs_lead: "Anunciaremos los DJs próximamente. Permaneced atentos.", djs_soon: "Por anunciar",
    eb_clases: "Clases", clases_h2: "<em>Clases.</em>", clases_lead: "Anunciaremos las clases próximamente. Permaneced atentos.", clases_soon: "Clase A (viernes) · Clase B (sábado)",
  ...
  eu: {
    ...
    eb_djs: "Talde artistikoa", djs_h2: "Baztango 20ko <em>DJak.</em>", djs_lead: "DJak laster iragarriko ditugu. Egon adi.", djs_soon: "Iragartzeke",
    eb_clases: "Klaseak", clases_h2: "<em>Klaseak.</em>", clases_lead: "Klaseak laster iragarriko ditugu. Egon adi.", clases_soon: "A klasea (ostirala) · B klasea (larunbata)",
  ...
  en: {
    ...
    eb_djs: "Artistic team", djs_h2: "Baztango 20 <em>DJs.</em>", djs_lead: "We will announce the DJs soon. Stay tuned.", djs_soon: "To be announced",
    eb_clases: "Classes", clases_h2: "<em>Classes.</em>", clases_lead: "We will announce the classes soon. Stay tuned.", clases_soon: "Class A (Friday) · Class B (Saturday)",
  ...
  fr: {
    ...
    eb_djs: "Équipe artistique", djs_h2: "Les <em>DJs de Baztango 20.</em>", djs_lead: "Nous annoncerons les DJs prochainement. Restez attentifs.", djs_soon: "À annoncer",
    eb_clases: "Cours", clases_h2: "<em>Cours.</em>", clases_lead: "Nous annoncerons les cours prochainement. Restez attentifs.", clases_soon: "Cours A (vendredi) · Cours B (samedi)",
  ...
  de: {
    ...
    eb_djs: "Künstlerisches Team", djs_h2: "Die <em>DJs von Baztango 20.</em>", djs_lead: "Die DJs geben wir in Kürze bekannt. Bleibt dran.", djs_soon: "Wird bekannt gegeben",
    eb_clases: "Kurse", clases_h2: "<em>Kurse.</em>", clases_lead: "Die Kurse geben wir in Kürze bekannt. Bleibt dran.", clases_soon: "Kurs A (Freitag) · Kurs B (Samstag)",
