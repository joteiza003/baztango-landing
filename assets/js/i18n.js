...
export const T = {
  es: {
    ...
    eb_clases: "Clases", clases_h2: "<em>Clases.</em>", clases_lead: "Dos clases con Bakartxo Arabaolaza, abiertas a ambos roles.", clases_a: "Viernes · Técnica de giro · ambos roles", clases_b: "Sábado · Sacadas · ambos roles",
  ...
  eu: {
    ...
    eb_clases: "Klaseak", clases_h2: "<em>Klaseak.</em>", clases_lead: "Bi klase Bakartxo Arabaolazarekin, bi rolentzat irekiak.", clases_a: "Ostirala · Biraketa teknika · bi rolak", clases_b: "Larunbata · Sacadak · bi rolak",
  ...
  en: {
    ...
    eb_clases: "Classes", clases_h2: "<em>Classes.</em>", clases_lead: "Two classes with Bakartxo Arabaolaza, open to both roles.", clases_a: "Friday · Turn technique · both roles", clases_b: "Saturday · Sacadas · both roles",
  ...
  fr: {
    ...
    eb_clases: "Cours", clases_h2: "<em>Cours.</em>", clases_lead: "Deux cours avec Bakartxo Arabaolaza, ouverts aux deux rôles.", clases_a: "Vendredi · Technique de giro · les deux rôles", clases_b: "Samedi · Sacadas · les deux rôles",
  ...
  de: {
    ...
    eb_clases: "Kurse", clases_h2: "<em>Kurse.</em>", clases_lead: "Zwei Kurse mit Bakartxo Arabaolaza, offen für beide Rollen.", clases_a: "Freitag · Drehtechnik · beide Rollen", clases_b: "Samstag · Sacadas · beide Rollen",
